...
int main(int argc, char ** argv)
{
        ...
        */
        ...
        while(fgets(f_buffer,40,fp)!=NULL)
        {
            ...
            //printf("Ship %d with %d parts is called %sdoi",ship_id,curr_size,f_buffer+numDig(curr_size)+1);
        }
            ...
            for(i=0; i<num_ships; i++)
            {
                ...
                */
                ...
                for(j=0; j<ships[i].size; j++)
                {
                    ...
                    {
                        printf(ANSI_COLOR_RED"HIT"ANSI_COLOR_RESET"\n");
                    }
                }
